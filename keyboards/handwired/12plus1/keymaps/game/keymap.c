...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT(
        QK_REBOOT,   KC_COPY, KC_PASTE, KC_VOLU,
    ...
    [NUM] = LAYOUT(
        KC_1,    KC_2,    KC_3,    KC_4,
        KC_5,    KC_6,    KC_7,    KC_8,
        TO(DRG),   KC_9,    KC_0,    XXXXXXX, QK_BOOT
    ),

    [DRG] = LAYOUT(
        DRGREADY1,    DRGREADY2,    KC_V,    KC_V,
        DRGPLAT,    DRGEGG,    KC_V,    KC_V,
        TO(ED),   XXXXXXX,    XXXXXXX,    KC_V, KC_V
    ),

    [ED] = LAYOUT(
        KC_U,    KC_1,    KC_3,    KC_4,
        KC_M,    KC_6,    KC_7,    KC_HOME,
        TO(BASE),   KC_F9,    KC_F10,    KC_L, KC_INS
    ),
